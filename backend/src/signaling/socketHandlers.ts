...
import type { ServerToClientEvents, ClientToServerEvents, ProducerInfo } from '../state/types.js';
import { v4 as uuidv4 } from 'uuid';

// Store socket metadata
const socketRooms = new Map<string, string>(); // socketId -> roomId
const socketPeers = new Map<string, string>(); // socketId -> peerId
const peerTransports = new Map<string, any>(); // peerId -> { producer: transport, consumer: transport }
const peerProducers = new Map<string, { video: any, audio: any }>(); // peerId -> producers
