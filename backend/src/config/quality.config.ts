...
export const SAFE_QUALITIES_T3_SMALL: QualityPreset[] = ['144p', '240p', '360p'];

// Default quality preset
export const DEFAULT_QUALITY: QualityPreset = '240p';

/**
 * Get quality settings for a given preset
 */
export function getQualitySettings(quality: QualityPreset): QualitySettings {
 ...
 */
export function getQualityName(quality: QualityPreset): string {
 ...
 */
export function isSafeQuality(quality: QualityPreset): boolean {
 ...
 */
export function getBandwidth(quality: QualityPreset): number {
